...
# Script di avvio per Android Simulator 2

echo "🚀 Avvio Android Simulator 2..."
...
qemu-system-x86_64 \
    ...
    -m 2G \
    -smp 2 \
    -drive file=/android/android2.img,format=qcow2 \
    -cdrom /android/android-x86.iso \
    -boot d \
    -netdev user,id=net0,hostfwd=tcp::5556-:5555,hostfwd=tcp::8081-:8080 \
...
echo "✅ Android Simulator 2 pronto!"
